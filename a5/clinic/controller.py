...
class Controller:
    ...
    # Create new patient profile if a user is logged in.
        ...
        # self.patient_list.append(Patient(phn, name, birth_date, phone, email, address))
        self.patient_dao.create_patient(Patient(phn, name, birth_date, phone, email, address, self.autosave))
        
        return Patient(phn, name, birth_date, phone, email, address, self.autosave)
    ...
    def update_patient(self, phn_for_lookup, phn, name, birth_date, phone, email, address):
